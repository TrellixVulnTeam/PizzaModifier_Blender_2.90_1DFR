...
const EnumPropertyItem rna_enum_object_modifier_type_items[] = {
    ...
    {eModifierType_Pizza, "PIZZA", ICON_MOD_ARRAY, "Pizza Modifier", ""},
    {0, NULL, 0, NULL, NULL},
};
...
static void rna_def_modifier_pizza(BlenderRNA *brna)
{
  ...
  // Define the RNA and bind it to PizzaModifierData
  ...
  // Blocks for each data field inside of pizza
  prop = RNA_def_property(srna, "num_olives", PROP_INT, PROP_NONE);
  RNA_def_property_range(prop, 0, 100);
  RNA_def_property_ui_range(prop, 0, 100, 1, -1);
  RNA_def_property_ui_text(prop, "Olives", "The number of olives on the pizza");
  RNA_def_property_update(prop, 0, "rna_Modifier_update");
}
